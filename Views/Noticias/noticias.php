...
<div class="body flex-grow-1 px-3" id="<?=$data['page_name']?>">
    ...
    <div class="mt-3">
        <div class="row">
            <div class="col-md-2">
                <div class="mb-3">
                    ...
                    <select class="form-control" aria-label="Default select example" id="intPorPagina" v-model="intPorPagina" @change="getBuscar(1,'noticias')">
            ...
            <div class="col-md-10">
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="strBuscar" v-model="strBuscar" @keyup="getBuscar(1,'noticias')">
                </div>
            </div> 
        </div>
                    ...
                    <tr v-for="(data,index) in arrData" :key="index">
                        ...
                        <td data-title="Opciones">
                            <div class="d-flex justify-content-center">
                                <button class="btn btn-success m-1" type="button" title="Editar" v-if="data.edit" @click="getDatos(data.id,'noticias')" ><i class="fas fa-pencil-alt"></i></button>
                                <button class="btn btn-danger m-1" type="button" title="Eliminar" v-if="data.delete" @click="delDatos(data.id,'noticias')" ><i class="fas fa-trash-alt"></i></button>
                            </div>
                        </td>
                    </tr>
                </tbody>
        ...
        <?php getComponent("paginationAdmin","noticias");?>
    </div>
</div>
