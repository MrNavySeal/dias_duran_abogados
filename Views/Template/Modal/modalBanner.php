                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" v-model="strBoton" value="">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label for="txtLink" class="form-label">Enlace</label>
                                <input type="text" class="form-control" v-model="strEnlace" required>
                            </div>
                        </div>
                    </div>
                    <div class="mb-3">
