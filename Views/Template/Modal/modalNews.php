                ...
                <form id="formItem" name="formItem" class="mb-4">
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            <div class="mb-3">
                                <label for="txtName" class="form-label">Categoría <span class="text-danger">*</span></label>
                                <select class="form-control" aria-label="Default select example" v-model="intCategoria" required>
                                    <option value="">Seleccione</option>
                                    <option v-for="(data,index) in arrCategorias" :value="data.id" :key="index">{{data.name}}</option>
                                </select>
                            </div>
                            <div class="mb-3">
