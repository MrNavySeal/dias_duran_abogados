...
<table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0">
  <tr>
    <td style="padding-right: 0px;padding-left: 0px;" align="center">
      ...
      <img align="center" border="0" src="https://assets.unlayer.com/projects/0/1748206133176-logo_45b5bd603a74.png?w=324.8px"  alt="<?=$company['name']?>" width="162.4"/>
      </a>
    </td>
  </tr>
</table>
    ...
    <tr>
      <td style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:helvetica,sans-serif;" align="left">
		<div style="font-size: 16px; line-height: 150%; text-align: left; word-wrap: break-word;">
			<p style="line-height: 150%;"><span style="color: #000000; line-height: 24px;">Hola <?= $data['nombreUsuario']; ?></span></p>
			<p style="line-height: 150%;"> </p>
			<p style="line-height: 150%;">
				<span style="color: #000000; line-height: 24px;">Solicitud de acceso del usuario: <strong><?= $data['email_usuario']; ?></strong>. Has solicitado recuperar su contraseña, haz click al botón, para continuar</p>:</span>
			<p style="line-height: 150%;"> </p>
      <p style="line-height: 150%;">
    ...
    <tr>
      <td style="overflow-wrap:break-word;word-break:break-word;padding:30px;font-family:helvetica,sans-serif;" align="left">
		...
		<div align="center">
			...
			<a href="<?= $data['url_recovery']; ?>" target="_blank" class="v-button" style="box-sizing: border-box;display: inline-block;text-decoration: none;-webkit-text-size-adjust: none;text-align: center;color: #ffffff; background-color: #b68c5a; border-radius: 0px;-webkit-border-radius: 0px; -moz-border-radius: 0px; width:auto; max-width:100%; overflow-wrap: break-word; word-break: break-word; word-wrap:break-word; mso-border-alt: none;font-size: 16px;font-weight: 700; ">
			<span style="display:block;padding:16px;line-height:120%;"><span style="line-height: 19.2px;">RECUPERAR CONTRASEÑA</span></span>
			</a>
		</div>
    ...
    <tr>
      <td style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:helvetica,sans-serif;" align="left">
		<div style="font-size: 16px; line-height: 150%; text-align: left; word-wrap: break-word;">
			...
			<p style="line-height: 150%;"> </p>
      <p style="line-height: 150%;">
				<span style="color: #000000; line-height: 24px;"><?=$data['url_recovery']?></span>
			</p>
		</div>
      </td>
    </tr>
