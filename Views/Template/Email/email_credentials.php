    ...
    <tr>
      <td style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:helvetica,sans-serif;" align="left">
		<div style="font-size: 16px; line-height: 150%; text-align: left; word-wrap: break-word;">
			<p style="line-height: 150%;"><span style="color: #000000; line-height: 24px;">Bienvenido a <?= $data['company']['name'] ?></span></p>
			<p style="line-height: 150%;"> </p>
			<p style="line-height: 150%;">
          Acceda a su cuenta con sus credenciales. Podrás actualizar tus datos y contraseña en tu perfil:<br>
          Usuario: <?= $data['email_usuario'] ?><br>
    ...
    <tr>
      <td style="overflow-wrap:break-word;word-break:break-word;padding:30px;font-family:helvetica,sans-serif;" align="left">
		...
		<div align="center">
			...
			<a href="<?=BASE_URL?>" target="_blank" class="v-button" style="box-sizing: border-box;display: inline-block;text-decoration: none;-webkit-text-size-adjust: none;text-align: center;color: #ffffff; background-color: #b68c5a; border-radius: 0px;-webkit-border-radius: 0px; -moz-border-radius: 0px; width:auto; max-width:100%; overflow-wrap: break-word; word-break: break-word; word-wrap:break-word; mso-border-alt: none;font-size: 16px;font-weight: 700; ">
			<span style="display:block;padding:16px;line-height:120%;"><span style="line-height: 19.2px;">INICIAR SESIÓN</span></span>
			</a>
		</div>
