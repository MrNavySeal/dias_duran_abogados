<?php
    class SeccionesModel extends Mysql{
        ...
        //Equipo
        public function selectEquipos($intPorPagina,$intPaginaActual, $strBuscar){
            $this->intPorPagina = $intPorPagina;
            $this->intPaginaActual = $intPaginaActual;
            $this->strBuscar = $strBuscar;
            $limit ="";
            ...
            $sql = "SELECT * FROM team WHERE name like '$this->strBuscar%' OR profession like '$this->strBuscar%' ORDER BY id DESC $limit";  
            $sqlTotal = "SELECT count(*) as total FROM team WHERE name like '$this->strBuscar%' OR profession like '$this->strBuscar%' ORDER BY id DESC";
        ...
        public function selectEquipo($id){
            $this->intId = $id;
            $sql = "SELECT * FROM team WHERE id = $this->intId";
            $request = $this->select($sql);
            return $request;
        }
        public function insertEquipo(string $strImagen,string $strNombre,int $intEstado, string $strProfesion){
			$this->strNombre = $strNombre;
			$this->strProfesion = $strProfesion;
            $this->strImagen = $strImagen;
            $this->intEstado = $intEstado;
            $sql  = "INSERT INTO team(picture,status,name,profession)  VALUES(?,?,?,?)";
            $arrData = array(
                $this->strImagen,
                $this->intEstado,
                $this->strNombre,
        ...
        public function updateEquipo(int $intId,string $strImagen,string $strNombre,int $intEstado, string $strProfesion){
            $this->intId = $intId;
            $this->strNombre = $strNombre;
			$this->strProfesion = $strProfesion;
            $this->strImagen = $strImagen;
            ...
            $sql = "UPDATE team SET picture=?,status=?,name=?, profession=? WHERE id = $this->intId";
            $arrData = array(
                $this->strImagen,
                $this->intEstado,
                $this->strNombre,
        ...
        public function deleteEquipo($id){
            $this->intId = $id;
            $sql = "DELETE FROM team WHERE id = $this->intId";
            $request = $this->delete($sql);
            return $request;
        }
