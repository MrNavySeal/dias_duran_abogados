...
const App = {
    data() {
        ...
        this.getBuscar(1,"equipo");
    },methods:{
        showModal:function(){
            this.strTituloModal = "Nuevo miembro";
            ...
            this.intEstado= 1;
            this.intId = 0;
            this.modal = new bootstrap.Modal(document.querySelector("#modalTeam"));
            this.modal.show();
        },
        setDatos: async function(){
            ...
            const response = await fetch(base_url+"/Secciones/setEquipo",{method:"POST",body:formData});
        ...
        getDatos:async function(intId,strTipo){
          this.intId = intId;
          this.strTituloModal = "Editar miembro";
          const formData = new FormData();
          formData.append("id",this.intId);
          formData.append("tipo_busqueda",strTipo);
